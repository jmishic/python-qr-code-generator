...
def mini_qr_code_maker(link: str) -> None:
    ...
    basic_qr_code.save("title-you-want-to-save-mini-as.png")
...
def border_qr_code_maker(link: str) -> None:
    ...
    border_qr_code.save("title-you-want-to-save-border-as.png", border=5)
...
def large_qr_code_maker(link: str) -> None:
    ...
    large_qr_code.save("title-you-want-to-save-large-as.png",  scale=10)
...
def colorful_qr_code_maker(link: str) -> None:
    ...
    large_qr_code.save("title-you-want-to-save-color-as.png", dark='darkblue', light='lightblue', scale=10)


def save_qr_code_as(link: str) -> None:
    # can save a qr code as .svg, .png, .eps, and .pdf
    save_as_qr_code = segno.make(link)
    save_as_qr_code.save("title.png")
    save_as_qr_code.save("title.svg")
    save_as_qr_code.save("title.pdf")
    save_as_qr_code.save("title.eps")
